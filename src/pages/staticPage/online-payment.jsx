  ...
  return (
   <>
      <Container>
        ...
        <p>Users can donate using QRscanner (phone pay), internet banking, Cheque or accounts, ensuring correct details and authorization to use lawfully in their possession and authorized for transactions.</p>
